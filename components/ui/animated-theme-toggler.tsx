...
export const AnimatedThemeToggler = ({
  ...
  useEffect(() => {
    // 1. Resolve the initial theme: saved value wins, else system preference
    ...
    // 2. Keep state in sync if some other code toggles the `dark` class
    const updateFromDom = () => {
    ...
    // 3. Follow OS theme changes ONLY if the user hasn't picked one yet
