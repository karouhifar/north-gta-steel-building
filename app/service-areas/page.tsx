                          ...
                          <CollapsibleContent className="px-4 pb-4">
                            <div className="border-t border-border pt-4">
                              ...
                              <Link
                                ...
                                className="mt-3 flex w-full items-center justify-center gap-2 rounded-xl border border-border px-4 py-3 text-center font-general text-xs font-medium uppercase tracking-[0.14em] text-foreground transition-colors hover:border-steel-red hover:text-steel-red"
                              >
                                Steel Buildings In {city.name}
                      ...
                      {group.cities.map((city) => {
                        ...
                        if (!cityMatch) {
                          return (
                            <span
                              key={city}
                              className="border border-border px-3 py-2 font-mono text-[10px] uppercase tracking-wider text-muted-foreground sm:text-[11px]"
                            >
                              {city}
                            </span>
                          );
                        ...
                        return (
                          <Link
                            key={city}
                            href={`/steel-buildings/${cityMatch.slug}`}
