    ...
    <section className="relative flex min-h-[100svh] overflow-hidden bg-background pt-24 text-foreground sm:pt-28 lg:pt-16">
      ...
      <div className="pointer-events-none relative z-10 mx-auto flex w-full max-w-screen-2xl items-end px-4 pb-14 sm:px-6 sm:pb-20 lg:min-h-[calc(100svh-4rem)] lg:px-12 lg:pb-24 xl:pb-28">
        ...
        <div className="grid w-full min-w-0 grid-cols-1 gap-8 lg:grid-cols-12">
          <div className="pointer-events-auto col-span-1 flex min-w-0 flex-col gap-y-5 lg:col-span-8 lg:max-w-[62vw] xl:col-span-6">
          ...
          <div className="pointer-events-none relative col-span-1 lg:col-span-6">
            <motion.div
              initial={{ opacity: 0, x: 80, scale: 0.96 }}
              animate={{ opacity: 1, x: 0, scale: 1 }}
              transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
              whileHover={{ y: -8, scale: 1.015 }}
              className="group pointer-events-auto absolute right-6 top-8 z-20 hidden w-[min(38vw,420px)] lg:block xl:right-12 xl:top-0 xl:w-[min(42vw,620px)] 2xl:right-16 2xl:w-[680px]"
            >
                ...
                <CardContent className="relative aspect-[6/4] overflow-hidden rounded-[1.5rem] p-0">
                  ...
                  <div className="pointer-events-none absolute bottom-0 left-0 right-0 translate-y-8 p-5 opacity-0 transition-all duration-500 ease-out group-hover:translate-y-0 group-hover:opacity-100 xl:p-6">
                    ...
                    <p className="mt-2 max-w-sm font-general text-xs leading-relaxed text-steel-offwhite xl:text-sm">
                      Clear-span structure engineered for commercial and
                      industrial applications across Ontario.
                    </p>
                  </div>
                </CardContent>
              </Card>
          ...
          <div className="flex flex-col gap-6 md:max-w-3xl md:flex-row md:items-start lg:max-w-none col-span-1 lg:col-span-12">
            <motion.p
            ...
            >
              Custom pre-engineered steel buildings for commercial, industrial,
              and agricultural applications. Uncompromising structural
              integrity. Zero aesthetic compromise.
            </motion.p>
